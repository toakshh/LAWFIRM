...
const Cards = import('./components/body/cards/Cards');
const Clients = import('./components/body/clients/Clients');
const Faq = import('./components/body/faq/Faq');
const Gallery = import('./components/body/gallery/Gallery');
const Intro = React.lazy(() => import('./components/body/intro/Intro'));
const Subscribe = React.lazy(() => import('./components/body/subscribe/Subscribe'));
const Team = React.lazy(() => import('./components/body/team/Team'));
const Footer = React.lazy(() => import('./components/footer/Footer'));
